      ...
      <div className="flex">
        ...
        <main className="flex-1 lg:ml-56 min-h-screen">
          <div className="max-w-full px-6 py-8">
            <div className="mb-6">
              <h1 className="text-xl font-semibold text-white mb-1">Edit Course</h1>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center space-x-2">
                  {formData.isPublished ? (
                    <span className="px-2 py-1 bg-emerald-600/10 text-emerald-400 text-xs font-medium rounded border border-emerald-600/20">
                      Published
                    </span>
                  ) : (
                    <span className="px-2 py-1 bg-yellow-600/10 text-yellow-400 text-xs font-medium rounded border border-yellow-600/20">
                      Draft
                    </span>
                  )}
                </div>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-shrink-0">
                  {formData.thumbnailUrl ? (
                    ...
                    <div className="w-32 h-20 bg-gray-700 rounded border border-gray-600 flex items-center justify-center">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center space-x-6 text-sm text-gray-300">
                    ...
                    <span>₦{formData.price?.toLocaleString() || '0'}</span>
            ...
            <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded text-sm font-medium transition-colors flex items-center space-x-2"
                >
              ...
              {showAddSection && (
                <div className="mb-6 p-4 bg-gray-700 rounded border border-gray-600">
                  ...
                  <form onSubmit={handleAddSection} className="space-y-4">
                    <div>
                      <label htmlFor="sectionTitle" className="block text-sm text-gray-300 mb-2">
                        Section Title *
                      </label>
                      <input
                        type="text"
                        ...
                        className="w-full px-3 py-2 bg-gray-600 border border-gray-500 rounded text-white placeholder-gray-400 focus:outline-none focus:border-blue-400"
